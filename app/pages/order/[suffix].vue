    ...
    <section class="order-shell">
      ...
      <section class="order-card">
        ...
        <template v-else-if="page">
          ...
          <div v-if="paid" class="success-box"><span class="success-icon">✓</span><div><strong>付款已提交</strong><span>{{ page.successText || '感谢付款，我们会按约定完成交付。' }}</span></div></div>
...
onMounted(async () => {
  try {
    if (paid.value) await $fetch(`/api/order/${encodeURIComponent(suffix.value)}/return`, { query: route.query })
